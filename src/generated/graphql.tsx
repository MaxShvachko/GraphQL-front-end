...
export type PostsQuery = { __typename?: 'Query', posts: { __typename?: 'PaginatedPost', hasMore: boolean, data: Array<{ __typename?: 'Post', id: number, points: number, createdAt: string, text: string, title: string, textSnippet: string }> } };
